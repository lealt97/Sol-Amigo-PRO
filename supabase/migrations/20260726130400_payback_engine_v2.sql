-- Payback v2: mantém compatibilidade com propostas antigas e usa o snapshot
...
begin
  ...
  if v_snapshot_version >= 2 then
    ...
    -- Compatibilidade para propostas concluídas antes do motor v2.
...
-- propostas v2 passam a usar o snapshot financeiro salvo no flow_state.
do $$
declare
  r record;
begin
